...
with DAG(
        dag_id="image_classification_dag_training_arbo",
    ...
    def prepare_pipeline_configs():
        ...
        configs = optimizer.get_task_configs("iisas_image_training", input_quantity=input_quantity,
    ...
    # NOTE: currently disable actual training for cluster reasons
